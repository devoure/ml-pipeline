...
def train_data():
    ...
    with mlflow.start_run():
        ...
        model = rf_regressor.fit(X_train, y_train)  # ravel() is used to convert y_train to 1D array

        # Make predictions on the testing set
        y_pred = rf_regressor.predict(X_test)
        y_pred_2 = rf_regressor.predict(X_train)
...
if __name__ == "__main__":
    kfp.compiler.Compiler().compile(pl_pipeline, "housing_rf.yaml")
